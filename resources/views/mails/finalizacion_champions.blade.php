...
<div style="text-align: center;"><p style="color:#09517d;font-size:18px;line-height:30px;margin-bottom: 0px;"><strong> ¡Eres una leyenda! </strong>
</p> </div></h2> </td> 
</tr> 
</tbody> 
</table> </td> 
...
<tr class="mktoModule"> 
  ...
  <div class="mktoText">
    <p>
      ...
      <strong>Has superado TODOS los niveles de los Desafíos Champions de esta temporada</strong>. Queremos darte una felicitación muy especial. Tu logro representa mucho para nosotros, y esperamos que tu bono acumulado refleje lo importante que es para nosotros tu compromiso. ¡Gracias por participar, y prepárate para mantener tu estatus legendario la próxima temporada!
      </p>
