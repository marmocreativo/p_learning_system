...
<div style="text-align: center;"><p style="color:#09517d;font-size:18px;line-height:30px;margin-bottom: 0px;"><strong>¡Felicidades!</strong>
</p> </div></h2> </td> 
</tr> 
</tbody> 
</table> </td> 
...
<tr class="mktoModule"> 
  ...
  <div class="mktoText">
    <p>
      ...
      <strong>Un árbitro del Desafío PLearning ha validado tu evidencia de venta</strong>, y ha declarado que cumpliste con los requisitos para completar el nivel. <strong>¡Continúa participando hasta desbloquear todos los bonos!</strong>
      </p>
        ...
        <table role="presentation" aria-hidden="true" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top: 0px;">
          <tbody>
            <tr style="background-color: #d1d2d4;">
              <td style="padding: 0px 10px; font-family: sans-serif; font-size: 14px; color: #000; font-weight: bold;">
                Desafío</td>
              <td style="padding: 0px 10px; font-family: sans-serif; font-size: 14px; color: #333333;">{{$desafio}}</td>
            </tr>
            <tr style="background-color: #f2f3f4;">
              <td style="padding: 0px 10px; font-family: sans-serif; font-size: 14px; color: #000; font-weight: bold;">Nivel</td>
              <td style="padding: 0px 10px; font-family: sans-serif; font-size: 14px; color: #333333;">{{$nivel}}</td>
            </tr>
            <tr style="background-color: #d1d2d4;">
              <td style="padding: 0px 10px; font-family: sans-serif; font-size: 14px; color: #000; font-weight: bold;">Status</td>
              <td style="padding: 0px 10px; font-family: sans-serif; font-size: 14px; color: #333333;">{{$status}}</td>
            </tr>
          </tbody>
        </table>
