...
<div style="text-align: center;"><p style="color:#09517d;font-size:18px;line-height:30px;margin-bottom: 0px;"><strong>Un nuevo canje ha llegado</strong>
</p> </div></h2> </td> 
</tr> 
</tbody> 
</table> </td> 
...
<div class="mktoText">
  <p>
    ...
    Se ha registrado un nuevo canje en la pagina de Recompensas. <br> Para visaulizarlo visita el panel de ganadores.
...
<tr class="mktoModule"> 
  ...
  <tr class="mktoModule"> 
    ...
    <div class="mktoText">
      <p>
        Ver más: <a href="{{ $data['boton_enlace'] }}" class="button">{{ $data['boton_texto'] }}</a>
      </p>

      <p>
        Si recibiste este correo por error o necesitas comunicarte con nostros, contáctanos.
      </p>
      <p><strong>Atte. Webmaster PLearning</strong></p>
