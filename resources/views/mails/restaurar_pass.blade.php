...
<div style="text-align: center;"><p style="color:#09517d;font-size:18px;line-height:30px;margin-bottom: 0px;"><strong> 
  Se ha solicitado restaurar la contraseña</strong>
</p> </div></h2> </td> 
</tr> 
</tbody> 
</table> </td> 
...
<tr class="mktoModule"> 
  ...
  <div class="mktoText">
    <p> 
      Da click en el siguiente enlace y tu contraseña será restaurada a una por defecto relacionada con tu empresa.</p> <p>Si no solicitaste el cambio de contraseña, comunícate inmediatamente con nosotros para informar de un problema de seguridad.</p>
    ...
    <tr style="display:noneIE; background-color: #FFFFFF;"> 
      ...
      <div class="mktoText"> 
      <a href="{{ $data['boton_enlace'] }}" target="_blank"><span style="font-size: 16px;"></span>RESTAURAR CONTRASEÑA</a> 
      </div> </td> 
      </tr> 
      </tbody> 
      </table> </td> 
