...
<style type="text/css">
    * {-webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;}
    ...
    .flex-button-a {
      margin:10px 10px; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold !important; background-color:#fbb03f; border:0px solid #fbb03f; border-radius:10px; border-collapse:collapse; text-align:center;
    }
    ...
    .flex-button-b {
      margin:10px 10px; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold !important; background-color:#f0b323; border:0px solid #f0b323; border-radius:10px; border-collapse:collapse; text-align:center;
    }
...
<div style="text-align: center;"><p style="color:#09517d;font-size:18px;line-height:30px;margin-bottom: 0px;"><strong> Tu contraseña para ingresar al sitio de PLearning fue restaurada</strong>
</p> </div></h2> </td> 
</tr> 
</tbody> 
</table> </td> 
...
<tr class="mktoModule"> 
  ...
  <div class="mktoText">
    <p> 
      En tu siguiente Inicio de Sesión en el programa, debes utilizar la contraseña que te enviamos, aunque te recomendamos cambiarla por una nueva apenas hayas iniciado sesión. <br><br> Si no solicitaste la restauración de contraseña, comunícate inmediatamente con nosotros para informar de un problema de seguridad. 
  ...
  <tr class="mktoModule"> 
    ...
    <tbody> 
    <tr> 
    <td style="padding: 0px 150px; text-align: left; font-family: sans-serif; font-size: 14px; line-height: 22px; color: #333333;"> 
    <div class="mktoText">
        ...
        <table role="presentation" aria-hidden="true" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top: 0px;">
          <tbody>
            <tr style="background-color: #d1d2d4;">
              <td style="padding: 15px 10px; font-family: sans-serif; font-size: 14px; color: #000; font-weight: bold;">
                Está es tu contraseña</td>
              <td style="padding: 0px 10px; font-family: sans-serif; font-size: 14px; color: #333333;">{{ $data['newpass'] }}</td>
            </tr>
          </tbody>
        </table>
    </div> </td> 
    ...
    <tr class="mktoModule"> 
      ...
      <div class="mktoText">
          <p>
            No comparte o revele su contraseña a nadie.
          </p>
      </div> </td> 
      </tr> 
      </tbody> 
    ...
    <tr style="display:noneIE; background-color: #FFFFFF;"> 
      <td align="center"> 
      <table class="mob-align-default" style="width:184px;" cellspacing="0" cellpadding="0" border="0"> 
      <tbody> 
      <tr> 
      <td class="flex-button-a"> 
      <div class="mktoText"> 
      <a href="{{ $data['boton_enlace'] }}" target="_blank"><span style="font-size: 16px;"></span>ENTRAR AHORA</a> 
      </div> </td> 
      </tr> 
      </tbody> 
      </table> </td> 
